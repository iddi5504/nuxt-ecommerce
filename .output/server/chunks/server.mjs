...
const _routes = [
  {
    name: (_a = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.name) != null ? _a : "products-id",
    path: (_b = __nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.path) != null ? _b : "/products/:id",
    file: "C:/Users/user/nuxt-ecommerce/pages/products/[id].vue",
    children: [],
    meta: __nuxt_page_meta$1,
    alias: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.alias) || [],
    redirect: (__nuxt_page_meta$1 == null ? void 0 : __nuxt_page_meta$1.redirect) || void 0,
    component: () => import('./_id_.af6651f3.mjs').then((m) => m.default || m)
  },
  {
    name: (_c = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.name) != null ? _c : "products",
    path: (_d = __nuxt_page_meta == null ? void 0 : __nuxt_page_meta.path) != null ? _d : "/products",
    file: "C:/Users/user/nuxt-ecommerce/pages/products/index.vue",
    children: [],
    meta: __nuxt_page_meta,
    alias: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.alias) || [],
    redirect: (__nuxt_page_meta == null ? void 0 : __nuxt_page_meta.redirect) || void 0,
    component: () => import('./index.34b06784.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  home: () => import('./home.d0211c6a.mjs').then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./error-component.45852fa0.mjs').then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
