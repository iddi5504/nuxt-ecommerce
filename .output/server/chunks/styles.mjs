...
const styles = {
  "pages/products/[id].vue": () => import('./_id_-styles.7232e761.mjs').then(interopDefault),
  ...
  "components/toast.vue": () => import('./toast-styles.51e47315.mjs').then(interopDefault),
  "components/cart.vue": () => import('./cart-styles.26b114ec.mjs').then(interopDefault)
};
